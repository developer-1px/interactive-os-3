...
const contentModules = import.meta.glob<Record<string, unknown>>('@p/ds/features/*.tsx', { eager: true })
const contentDemoModules = import.meta.glob<{ default: ComponentType }>('@p/ds/features/_demos/*.demo.tsx', { eager: true })
...
const surfaceModules = import.meta.glob<Record<string, unknown>>('@p/ds/shells/*/*.tsx', { eager: true })
const surfaceDemoModules = import.meta.glob<{ default: ComponentType }>('@p/ds/shells/*/_demos/*.demo.tsx', { eager: true })
