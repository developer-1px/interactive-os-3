...
export const PARTS: PartEntry[] = [
  ...
  { name: 'Badge',      doc: 'counter(숫자) 또는 status dot. tone=success/warning/danger.', demo: <Badge count={3} variant="danger" label="3 unread" /> },
  ...
  { name: 'Callout',    doc: 'info/success/warning/danger 메시지 박스. role 자동.',         demo: <Callout variant="info">정보 메시지입니다.</Callout> },
