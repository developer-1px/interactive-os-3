...
import { dot, listRow, meta, type } from '../wireframe-tokens'

defineGroup('P-Notifications', { id: 'P', title: 'Notifications', lede: 'GitHub 식 알림함 — filter Tabs · unread dot · avatar row.' })
