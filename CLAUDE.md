...
3-tier import 방향: palette (raw scale) → semantic (text/surfaceMuted/borderLevel) → component. **widget 은 semantic 만 import.** color pair 는 surface 소유자만 (item 이 자기 색을 선언 ❌).
