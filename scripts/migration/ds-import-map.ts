...
export const MIGRATION_RULES: MigrationRule[] = [
  ...
  {
    from: '@p/ds/ui/2-action/Switch',
    to: '@p/ds/ui/2-action/Switch',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
  {
  ...
  {
    from: '@p/ds/ui/3-input/Input',
    to: '@p/ds/ui/3-input/Input',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
  {
    from: '@p/ds/ui/3-input/Textarea',
    to: '@p/ds/ui/3-input/Textarea',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
  {
    from: '@p/ds/ui/3-input/Slider',
    to: '@p/ds/ui/3-input/Slider',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
  {
    from: '@p/ds/ui/3-input/Select',
    to: '@p/ds/ui/3-input/Select',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
  {
    from: '@p/ds/ui/3-input/SearchBox',
    to: '@p/ds/ui/3-input/SearchBox',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
  {
    from: '@p/ds/ui/4-selection/Option',
    to: '@p/ds/ui/4-selection/Option',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
  {
