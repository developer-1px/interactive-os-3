...
export const MIGRATION_RULES: MigrationRule[] = [
  ...
  {
    from: '@p/ds/ui/8-field/Field',
    to: '@p/ds/ui/8-field/Field',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
  {
  ...
  {
    from: '@p/ds/ui/9-layout/Split',
    to: '@p/ds/ui/9-layout/Split',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
  {
    from: '@p/ds/ui/9-layout/ZoomPanCanvas',
    to: '@p/ds/ui/9-layout/ZoomPanCanvas',
    kind: 'preserved',
    reason: 'co-location 보존',
  },
