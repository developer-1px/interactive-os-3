...
const REWRITES = [
  ...
  ['@p/ds/style/preset/breakpoints', '@p/ds/tokens/style/preset/breakpoints'],
  ['@p/ds/style/preset', '@p/ds/tokens/style/preset'],
  ['@p/ds/style/seed', '@p/ds/tokens/style/seed'],
  ['@p/ds/style/shell', '@p/ds/tokens/style/shell'],
  ['@p/ds/style/states', '@p/ds/tokens/style/states'],
  // L2
