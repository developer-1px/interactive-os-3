...
CANONICAL.md 26-27행이 명문화했다 — "셀렉터 어휘: tag + role + aria + data-part", "data-part는 content 부품 어휘 (packages/ds/src/parts/)". `packages/ds/src/parts/Card.tsx:28` 에서 root가 `data-part="card"`를 직접 박는다. 호출자에게 className prop을 받지 않는다.
...
- `/Users/user/Desktop/ds/packages/ds/src/parts/Card.tsx:11,28` — root가 박는 namespace
- `/Users/user/Desktop/ds/packages/ds/src/parts/Badge.tsx:24` — 동일 패턴
