...
`src/ds/core/flow.ts:39-62` `useFlow` 본체가 useResource + useControlState + useEventBridge 3개를 합성해 (data, onEvent) 한 쌍으로 내놓는다. 즉 한 줄은 **합성된 인터페이스**의 한 줄이지 "복잡도 0"의 한 줄이 아니다.
...
- `/Users/user/Desktop/ds/src/ds/core/flow.ts:39-62` — useFlow 합성 본체
