...
import { composeAxes, navigate, activate } from '@p/headless'
import { composeGestures, selectionFollowsFocus } from '@p/headless'
export const axis = composeAxes(navigate('horizontal'), activate)
...
```tsx
import { useControlState, useRovingTabIndex, fromTree, ROOT } from '@p/headless'
...
```ts
import { fromTree, ROOT } from '@p/headless'
