...
export const contractCard = () => css`
  ...
  article[data-part="card"] > [data-slot="title"] > header > [data-badge]::before {
    content: '';
    display: inline-block;
    inline-size: 0.5em; block-size: 0.5em; border-radius: 50%;
  }
  article[data-part="card"] > [data-slot="title"] > header > [data-badge][data-tone="good"]::before { background: ${status('success')}; }
  article[data-part="card"] > [data-slot="title"] > header > [data-badge][data-tone="warn"]::before { background: ${status('warning')}; }
  article[data-part="card"] > [data-slot="title"] > header > [data-badge][data-tone="bad"]::before  { background: ${status('danger')}; }
  ...
  article[data-part="card"]:hover > [data-slot="title"] > header > [data-part="code"],
  article[data-part="card"]:focus-within > [data-slot="title"] > header > [data-part="code"],
  article[data-part="card"][data-selected="true"] > [data-slot="title"] > header > [data-part="code"],
  article[data-part="card"]:hover > [data-slot="title"] > header > [data-part="heading"][data-level="caption"],
  article[data-part="card"]:focus-within > [data-slot="title"] > header > [data-part="heading"][data-level="caption"],
  article[data-part="card"][data-selected="true"] > [data-slot="title"] > header > [data-part="heading"][data-level="caption"] {
    display: block;
  }

  /* meta·body·checks 슬롯 — 평소 숨김. hover/focus/selected 시에만 펼침. */
  article[data-part="card"] > :where([data-slot="meta"], [data-slot="body"], [data-slot="checks"]) {
    display: none;
  }
  article[data-part="card"]:hover > :where([data-slot="meta"], [data-slot="body"], [data-slot="checks"]),
  article[data-part="card"]:focus-within > :where([data-slot="meta"], [data-slot="body"], [data-slot="checks"]),
  article[data-part="card"][data-selected="true"] > :where([data-slot="meta"], [data-slot="body"], [data-slot="checks"]) {
    display: block;
  }
  ...
  article[data-part="card"]:focus-within,
  article[data-part="card"][data-selected="true"] {
