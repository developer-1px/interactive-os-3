...
| `useTreeGridPattern` | [`/treegrid/`](https://www.w3.org/WAI/ARIA/apg/patterns/treegrid/) | `(data, onEvent, opts?) → { rootProps, rowProps, cellProps, items }` | `selectionMode?` | `treeNavigate` + `treeExpand` + rowheader/gridcell semantics | tree-visible row focus with grid cells |
