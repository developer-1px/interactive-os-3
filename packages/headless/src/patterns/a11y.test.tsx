...
describe('axe-core ARIA compliance', () => {
  ...
  it('treegrid', async () => {
    const data = grid3x2()
    function C() {
      const { treegridProps, headerRowProps, rowProps, columnheaderProps, rowheaderProps, gridcellProps, items } =
        useTreeGridPattern(data, undefined, { label: 'Items', colCount: 2 })
      return (
        <div {...treegridProps}>
          <div {...headerRowProps}>
