import { accent, accentTint, control, css, dur, ease, hairlineWidth, onAccent, radius, square, status, statusTint, surface, surfaceTint } from '../../tokens/foundations'
 ...
 *
 * 계층 (강→약):
 * 1. Primary — `[data-part="actions"] > button` (페이지 top-level CTA 영역)
...
export const cssButton = () => css`
  ...
  /* ── Primary (actions 영역의 "주" 버튼 하나) ─────────────────────
     [data-part="actions"] 안의 첫 번째 버튼만 primary로 승격.
